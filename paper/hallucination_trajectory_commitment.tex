...
\vspace{-0.5em}
\begin{center}
\small Code and data: \url{https://github.com/akarlaraytu/trajectory-commitment}
\end{center}
\vspace{0.5em}
...
\paragraph{Reproducibility.} All code, data, and figures are publicly available at \url{https://github.com/akarlaraytu/trajectory-commitment}.
